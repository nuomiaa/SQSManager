//通用登陆 API js
SQSERVER.login = function (username, password, rand, loginSuccess, loginError, error) {
  var POST_OBJECT = null;
  $.get({
    url: SQSERVER.URL("./user/login_key"),
    //import
    data: {
      username: username,
