...
(function () {
  ...
  // 获取菜单栏状态
  SQSERVER.getColmStatus = function () {
  ...
  SQSERVER.colmSet = function (booleans) {
  ...
  SQSERVER.colmDo = function () {
    // if ($Container[0].style.left == '0px') {
    // 	SQSERVER.colmSet(true);
    // } else {
    // 	SQSERVER.colmSet(false);
    // }
  };

  SQSERVER.autoColmDo = function () {
  ...
  window.onload = SQSERVER.autoColmDo;
